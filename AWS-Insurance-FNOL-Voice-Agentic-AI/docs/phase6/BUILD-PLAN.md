...
| **6** | **Tier B harness + judge** — everything needing a live model: intent macro-F1, groundedness, answer relevance, abstention, compound-case correctness, per-conversation cost and agent-internal latency, and `CF3`'s repeated tight-turn sampling | Stages 3–5 | **Yes — the bulk of Phase 6's spend** |
