"""Streaming subprocess wrapper for az / docker / ssh invocations.

Ported from
Azure-Agentic-Video-Surveillance/src/surveil_deploy/runner.py verbatim
(generic subprocess plumbing, nothing project-specific), only the console
import path changed.
"""
...
from forecast_deploy.console import console
